...
class AddproductController extends Controller
{
    ...
    public function add_product(Request $request)
    {
        ...
        $store_idd=$request->store_id;
       $varient_idd=$request->varient_id;
    	 ...
    	 $store= DB::table('store')
            ...
            $pr= DB::table('product_varient')
                 ->where('varient_id',$varient_idd)
                 ->first();
                 
            $insert2 = DB::table('store_products')
                  ->insert(['store_id'=>$store_idd,'stock'=>0, 'varient_id'=>$varient_idd, 'price'=>$pr->base_price,'mrp'=>$pr->base_mrp]);
    ...
    public function add_products2(Request $request)
    {
       $store_id=$request->store_id;
