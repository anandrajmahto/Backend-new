...
Route::group(['prefix'=>'store', ['middleware' => ['XSS']], 'namespace'=>'Storeapi'], function(){
    ...
    Route::post('storeconfirm1', 'StoreorderController@storeconfirm');
    ...
    Route::post('store_add_product', 'AddproductController@add_product');
    Route::post('earn', 'AmountController@earn');
    Route::post('payout_request', 'PayoutController@request');
...
Route::group(['prefix'=>'driver', ['middleware' => ['XSS']], 'namespace'=>'Driverapi'], function(){
    ...
    Route::post('driver_login_new', 'DriverloginController@driver_login_new');
    ...
    Route::post('nextdayordsearch', 'SearchordController@nextdaysearch');
     ...
     //wallet
     Route::post('recharge_wallet', 'WalletControllerDriver@add_credit');
     Route::post('totalbill', 'WalletControllerDriver@totalbill');
     Route::post('show_recharge_history', 'WalletControllerDriver@show_recharge_history');
     Route::post('walletamount_driver', 'WalletControllerDriver@walletamount');
